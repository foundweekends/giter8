...
object Dependencies {
  ...
  val jgit = "org.eclipse.jgit" % "org.eclipse.jgit.pgm" % "5.10.0.202012080955-r" excludeAll (
    ExclusionRule("javax.jms", "jms"),
    ExclusionRule("com.sun.jdmk", "jmxtools"),
    ExclusionRule("com.sun.jmx", "jmxri")
  )
  val jgitJsch             = "org.eclipse.jgit" % "org.eclipse.jgit.ssh.jsch" % "5.10.0.202012080955-r"
  ...
  val coursier             = "io.get-coursier" %% "coursier" % "2.0.12"
  val launcherIntf         = "org.scala-sbt" % "launcher-interface" % "1.1.6"
}
